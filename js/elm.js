...
var $author$project$Mbta$serviceDateToIso8601 = function (_v0) {
	var iso8601 = _v0.a;
	return iso8601;
};
...
var $author$project$MakeViewModel$scheduleToTime = function (schedule) {
	var _v0 = _Utils_Tuple2(schedule.arrivalTime, schedule.departureTime);
	if (_v0.b.$ === 'Just') {
		var departureTime = _v0.b.a;
		return $elm$core$Maybe$Just(departureTime);
	} else {
		if (_v0.a.$ === 'Just') {
			var arrivalTime = _v0.a.a;
