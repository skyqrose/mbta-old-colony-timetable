	...
	return A2(
		...
		_List_fromArray(
			[
				...
				stopHeader.accessible ? mdgriffith$elm_ui$Element$text('accessible') : mdgriffith$elm_ui$Element$text(' ')
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				trip.bikes ? mdgriffith$elm_ui$Element$text('bikes') : mdgriffith$elm_ui$Element$text(' ')
			]));
};
