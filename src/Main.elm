...
viewData routes stops schedules tripGetter =
    ...
    El.column
        [ El.spacing 10 ]
        [ viewTimetable stopDict inboundSchedules tripGetter
        , viewTimetable stopDict outboundSchedules tripGetter
        ]


viewTimetable : Dict Mbta.StopId Mbta.StopId -> List Mbta.Schedule -> (Mbta.TripId -> Maybe Mbta.Trip) -> Element msg
viewTimetable stopDict schedules tripGetter =
    let
